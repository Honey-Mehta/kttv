...
class Timetable_model extends Base_module_model
{
    public $required = array('headline','description','pdf');
    public $record_class = 'Timetable_item_model';

    function __construct()
    {
        parent::__construct('timetable'); // table name
    }
    ...
    function list_items($limit = NULL, $offset = NULL, $col = 'id', $order = 'desc', $just_count = false)
    {
        ...
        foreach ($data as $key => $value) {
            ...
            if (!empty($value['pdf'])) {
                $data[$key]['pdf'] = '<a href="' . img_path('timetable/' . $value['pdf']) . '" target="_blank">Download PDF</a>';
            }
        }
    ...
    function form_fields($values = array(), $related = array())
    {
        ...
        $fields['pdf'] = array(
            'type' => 'asset',
            'multiple' => FALSE,
            'folder' => 'images/timetable', // Updated folder path
            'hide_options' => TRUE,
...
class Timetable_item_model extends Base_module_record
{
