...
class Notifications_model extends Base_module_model
{
    ...
    public $record_class = 'Notifications_item_model';

    function __construct()
    {
        parent::__construct('notifications'); // table name
    }
    ...
    function list_items($limit = NULL, $offset = NULL, $col = 'id', $order = 'desc', $just_count = false)
    {
        ...
        foreach ($data as $key => $value) {
            ...
            if (!empty($value['pdf'])) {
                $data[$key]['pdf'] = '<a href="' . img_path('notifications/' . $value['pdf']) . '" target="_blank">Download PDF</a>';
            }
        }
    ...
    function form_fields($values = array(), $related = array())
    {
        ...
        $fields['pdf'] = array(
            'type' => 'asset',
            'multiple' => FALSE,
            'folder' => 'images/notifications', // Updated folder path
            'hide_options' => TRUE,
...
class Notifications_item_model extends Base_module_record
{
